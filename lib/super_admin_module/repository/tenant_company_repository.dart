...
abstract class ITenantCompanyRepository {
  ...
  Future<void> updateUserLocation(String userId, String companyId, UserInfoDto userInfoDto);
  Future<void> markAttendance(String userId, String companyId, AttendanceDTO attendance);
  Future<List<AttendanceDTO>> getAttendance(String userId, String companyId, String month);
  Future<void> recordSalaryPayment(String userId, String companyId, double amount, String month);
  Future<void> recordAdvanceSalary(String userId, String companyId, double amount, String date);
  Future<List<Map<String, dynamic>>> getLedger(String userId, String companyId, String? month);
  Future<List<Map<String, dynamic>>> getSalaryHistory(String userId, String companyId);
