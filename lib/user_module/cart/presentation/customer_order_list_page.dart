...
class _CustomerOrderListPageState extends State<CustomerOrderListPage> {
  ...
  Widget _buildCustomerCard(MapEntry<UserInfo, List<Order>> entry) {
                ...
                child: Container(
                  ...
                  child: Table(
                    ...
                    children: [
                      ...
                      _buildTableRow('Last Order', daysSinceLastOrder),
                      _buildTableRow(
                        'Total',
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: const CustomAppBar(title: 'Top Customer'),
        body: Container(
          decoration: BoxDecoration(
                    ...
                    if (state is AdminOrderListFetchLoading) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _buildCustomerCard(entry);
                        },
                      );
                    }
