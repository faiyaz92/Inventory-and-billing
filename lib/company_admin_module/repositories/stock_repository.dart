...
class StockRepositoryImpl implements StockRepository {
  ...
  Future<List<StockDto>> getStock(String companyId, String? storeId) async {
    try {
      ...
      final ref = firestore.collection(firestorePathProvider.getStockCollectionRef(companyId, effectiveStoreId));
  ...
  Future<List<StoreDto>> getStores(String companyId) async {
    try {
      final ref = firestore.collection(firestorePathProvider.getStoresCollectionRef(companyId));
      final snapshot = await ref.get();
  ...
  Future<String> getDefaultStoreId(String companyId) async {
    ...
    if (stores.isEmpty) {
      ...
      await firestore
          .collection(firestorePathProvider.getStoresCollectionRef(companyId))
